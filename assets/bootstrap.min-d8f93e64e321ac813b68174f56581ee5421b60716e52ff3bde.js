    ...
    (function (r) {
            ...
            (o.prototype.toggle = function (t) {
                ...
                if (!e.is(".disabled, :disabled")) {
                    var i = l(e),
                        o = i.hasClass("open");
                    if ((s(), !o)) {
                        "ontouchstart" in document.documentElement && !i.closest(".navbar-nav").length && r('<div class="dropdown-backdrop"/>').insertAfter(r(this)).on("click", s);
            ...
            (o.prototype.keydown = function (t) {
                if (/(38|40|27|32)/.test(t.which) && !/input|textarea/i.test(t.target.tagName)) {
                    ...
                    if ((t.preventDefault(), t.stopPropagation(), !e.is(".disabled, :disabled"))) {
                        var i = l(e),
                            o = i.hasClass("open");
                        if ((!o && 27 != t.which) || (o && 27 == t.which)) return 27 == t.which && i.find(h).trigger("focus"), e.trigger("click");
                        var n = " li:not(.disabled):visible a",
                            s = i.find('[role="menu"]' + n + ', [role="listbox"]' + n);
                        if (s.length) {
                            var a = s.index(t.target);
                            38 == t.which && 0 < a && a--, 40 == t.which && a < s.length - 1 && a++, ~a || (a = 0), s.eq(a).trigger("focus");
                        }
                    }
                }
            });
        ...
        (r.fn.dropdown = t),
            ...
            r(document)
                ...
                .on("keydown.bs.dropdown.data-api", h, o.prototype.keydown)
                .on("keydown.bs.dropdown.data-api", '[role="menu"]', o.prototype.keydown)
                .on("keydown.bs.dropdown.data-api", '[role="listbox"]', o.prototype.keydown);
    })(jQuery),
    (function (s) {
        "use strict";
        function a(o, n) {
                ...
                this.$element.trigger(t),
                    this.isShown ||
                        ...
                        this.backdrop(function () {
                            ...
                            o.$element.parent().length || o.$element.appendTo(o.$body), o.$element.show().scrollTop(0), o.adjustDialog(), t && o.$element[0].offsetWidth, o.$element.addClass("in").attr("aria-hidden", !1), o.enforceFocus();
            ...
            (r.prototype.hide = function (t) {
                t && t.preventDefault(),
                    ...
                    this.isShown &&
                        ...
                        s.support.transition && this.$element.hasClass("fade") ? this.$element.one("bsTransitionEnd", s.proxy(this.hideModal, this)).emulateTransitionEnd(r.TRANSITION_DURATION) : this.hideModal());
            }),
    ...
    (function (m) {
        ...
        function t(o) {
            return this.each(function () {
                var t = m(this),
                    e = t.data("bs.tooltip"),
                    i = "object" == typeof o && o;
                (e || !/destroy|hide/.test(o)) && (e || t.data("bs.tooltip", (e = new v(this, i))), "string" == typeof o && e[o]());
            });
        }
        var v = function (t, e) {
        ...
        (v.VERSION = "3.3.4"),
            ...
            (v.prototype.enter = function (t) {
                ...
                return e && e.$tip && e.$tip.is(":visible")
                    ? void (e.hoverState = "in")
                    : (e || ((e = new this.constructor(t.currentTarget, this.getDelegateOptions())), m(t.currentTarget).data("bs." + this.type, e)),
            ...
            (v.prototype.show = function () {
                ...
                if (this.hasContent() && this.enabled) {
                    ...
                    if (r) {
                        var p = s,
                            c = this.options.container ? m(this.options.container) : this.$element.parent(),
                            f = this.getPosition(c);
                        (s = "bottom" == s && l.bottom + d > f.bottom ? "top" : "top" == s && l.top - d < f.top ? "bottom" : "right" == s && l.right + h > f.width ? "left" : "left" == s && l.left - h < f.left ? "right" : s),
            ...
            (v.prototype.hide = function (t) {
                ...
                return (
                    ...
                    n.isDefaultPrevented() ? void 0 : (o.removeClass("in"), m.support.transition && o.hasClass("fade") ? o.one("bsTransitionEnd", e).emulateTransitionEnd(v.TRANSITION_DURATION) : e(), (this.hoverState = null), this)
                );
            }),
